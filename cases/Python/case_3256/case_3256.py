...
def CaseArgumentParser():
    ...
    parser.add_argument('--numberOfTests', default=15,type=int)
    parser.add_argument('--segmentsperbuffer', default=1000)
    return parser
...
def CaseRun(args):
    ...
    for test in range(number_of_tests):
        ...
        if KY_DEVICE_INFO_FLAGS.GRABBER != device_info.m_Flags or device_info.isVirtual:
            print('Test could not run on this grabber')
            return CaseReturnCode.COULD_NOT_RUN
...
if __name__ == "__main__":
    try:
        print("case 3256 Process ID:", os.getpid())
        args_ = ParseArgs()
