...
def CaseRun(args):
    ...
    (status, serialNumber) = KYFG_GetGrabberValueStringCopy(grabberHandle, "DeviceSerialNumber")
    print("Grabber Serial Number: ", hex(int(serialNumber)))
    KYFG_Close(grabberHandle)
    assert serialNumber and int(serialNumber) != 4294967295, "Wrong serial number"
...
if __name__ == "__main__":
    try:
        print("case 4504 Process ID:", os.getpid())
        args_ = ParseArgs()
