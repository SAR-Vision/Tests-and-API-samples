...
def CaseRun(args):
    ...
    for i in range(len(camList)):
        ...
        KYFG_SetGrabberValueInt(grabberHandle, "StreamChannelSelector", i)
        ...
        if (StreamRxPackets == 0 and StreamDropPackets == 0) or (StreamRxFrames == 0 and StreamDropFrames == 0):
        ...
        print(f'StreamRxPackets {StreamRxPackets}')
        print(f'DropPacketCounter {StreamDropPackets}')
        print(f'StreamRxFrames {StreamRxFrames}')
        print(f'StreamDropFrames {StreamDropFrames}')
        if StreamRxPackets != StreamDropPackets != StreamRxFrames != StreamDropFrames != 0:
