...
def CaseArgumentParser():
    ...
    parser.add_argument('--BandwidthTestPayloadBufferSize', default=4097.0, type=float, help='Bandwidth Test Pay load Buffer Height')
    parser.add_argument('--BandwidthTestPayloadBuffersCount', default=1, type=int, help='Bandwidth Test Payload BuffersCount')
...
def CaseRun(args):
    ...
    for i in averfgeSpeedList:
        assert PCIMiddleBandwidth - 500 <= i <= PCIMiddleBandwidth + 500, 'The average speed not in boundaries'
