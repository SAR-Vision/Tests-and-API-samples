...
def CaseRun(args):
    ...
    cameraHandle = ConnectToCamera(grabberHandle)
    ...
    print(f'Pipe QTY at the start: {pipes_num_first}')
    print(f'Pipe QTY at the stop:  {pipes_num_second}')
    assert pipes_num_second == pipes_num_first, 'the number of pipes before CameraStart and after CameraStop does not match'
...
if __name__ == "__main__":
    try:
        print("case 3101 Process ID:", os.getpid())
        args_ = ParseArgs()
