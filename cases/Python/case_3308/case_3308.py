...
def CaseRun(args):
    ...
    numberOfSentTriggers = args["numberOfSentTriggers"]
    ...
    for cameraHandle in cameraList:
        ...
        (status,) = KYFG_SetGrabberValueEnum_ByValueName(grabberHandle, "PulseMessageMode", "Basic")
...
if __name__ == "__main__":
    try:
        print("case 3308 Process ID:", os.getpid())
        args_ = ParseArgs()
