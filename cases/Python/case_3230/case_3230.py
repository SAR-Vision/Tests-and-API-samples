...
def CaseArgumentParser():
    ...
    parser.add_argument('--chameleonDeviceIndex', type=int, default=0, help='Index of PCI device to use, run this script with "--deviceList" to see available devices and exit')
    parser.add_argument('--camera', type=str, default='Chameleon', help='Index of PCI device to use, run this script with "--deviceList" to see available devices and exit')
    return parser
...
def CaseRun(args):
    ...
    if chameleon_device_index is None:
