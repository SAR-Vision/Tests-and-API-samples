...
def CaseArgumentParser():
    ...
    parser.add_argument('--example', type=str, default='KYFGLib_Multi-stream_Camera_Example', help='Name of example folder')
...
def CaseRun(args):
    ...
    assert process.returncode in range(0, 2) and '0 cameras detected' not in output.strip(), 'Test not Passed'
