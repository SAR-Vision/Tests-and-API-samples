...
def CaseArgumentParser():
    ...
    parser.add_argument('--requestFrequency', type=float, default=1000, help="Frequency of requests of device temperature"                                                             "in uSec")
    return parser
...
if __name__ == "__main__":
    try:
        print("case 4764 Process ID:", os.getpid())
        args_ = ParseArgs()
