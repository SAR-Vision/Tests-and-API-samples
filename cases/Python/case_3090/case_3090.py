...
def CaseArgumentParser():
    ...
    parser.add_argument('--chameleonDeviceIndex', type=int, default=1, help='Index of Chameleon device to use')
    parser.add_argument('--camera', type=str, default='Chameleon', help='Chameleon deviceModelName')
...
if __name__ == "__main__":
    try:
        print("case 3090 Process ID:", os.getpid())
        args_ = ParseArgs()
