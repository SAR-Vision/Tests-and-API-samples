...
def CaseRun(args):
    ...
    root_directory = current_directory.joinpath('binary_test_executables').joinpath('case_4424')
    projectFile = root_directory.joinpath("Case_4424/Case_4424.csproj").absolute().as_posix()
