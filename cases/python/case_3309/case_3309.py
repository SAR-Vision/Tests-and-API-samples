...
def CaseRun(args):
    ...
    for cameraHandle in cameraList:
        ...
        KYFG_SetGrabberValueBool(grabberHandle, "ImageAcquisitionFilterEnable", True)
        KYFG_SetGrabberValueInt(grabberHandle, "ImageAcquisitionFilterSelector", 255)
        KYFG_SetGrabberValueEnum_ByValueName(grabberHandle, "ImageAcquisitionFilterValue", "Active")
        ...
        if numberOfFrames == 0 or dropFrameCounter != 0:
