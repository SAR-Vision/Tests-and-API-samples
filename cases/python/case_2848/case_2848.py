...
def CaseArgumentParser():
    ...
    parser.add_argument('--number_of_tests',type=int, default=1, help='Number of cycles: start-stop-singleFrame')
    return parser
...
def CaseRun(args):
    ...
    command = [vision_point_exe, "--guiscript", js_case_file, "--guiscriptParameters",
               f"--deviceIndex {device_index} --number_of_tests {number_of_tests}"]
