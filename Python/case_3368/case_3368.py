...
def CaseArgumentParser():
    ...
    parser.add_argument('--number_of_tests', type=int, default=3, help='Number of grabbing single image')
...
def CaseRun(args):
    ...
    command = [vision_point_exe, "--guiscript", js_case_file, "--guiscriptParameters",
               f"--deviceIndex {device_index} --number_of_tests {number_of_tests} --cameraIndex {cameraIndex}",
               ]
